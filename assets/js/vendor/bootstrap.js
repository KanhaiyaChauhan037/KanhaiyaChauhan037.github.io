! function(t, e) {
    ...
    var C = "collapse",
        ...
        k = ((n = A.prototype).toggle = function() {
            ...
            var t, e, n, i, o = this;
            this._isTransitioning || d.default(this._element).hasClass("show") || (i = this._parent && 0 === (i = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
    ...
    var z = "tooltip",
        ...
        tt = ((n = et.prototype).enable = function() {
            ...
            "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = V(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? d.default(e).parent().is(t) || t.empty().append(e) : t.text(d.default(e).text())
        }, n.getTitle = function() {
