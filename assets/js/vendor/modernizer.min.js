! function(i, f, d) {
    ...
    e.mq = x, e.prefixedCSSValue = function(e, t) {
        var n = !1,
            o = p("div").style;
        if (e in o) {
            var r = w.length;
    ...
    var z = !1;
    try {
        z = "WebSocket" in i && 2 === i.WebSocket.CLOSING
    } catch (e) {}
    g.addTest("websockets", z), g.addTest("cssanimations", A("animationName", "a", !0)),
        function() {
            ...
            var e, t, n = p("img"),
                o = "sizes" in n;
            !o && "srcset" in n ? (e = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", t = function() {
                l("sizes", 2 == n.width)
            }, n.onload = t, n.onerror = t, n.setAttribute("sizes", "9px"), n.srcset = e + " 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 8w", n.src = e) : l("sizes", o)
    ...
    for (var O = 0; O < g._q.length; O++) g._q[O]();
    i.Modernizr = g
}(window, document);