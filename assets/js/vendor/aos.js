! function(e, t) {
    ...
    function m(n, o, e) {
        ...
        function g() {
            ...
            if (i = arguments, a = this, u = e, t) {
                if (void 0 === c) return d = t = u, c = setTimeout(b, o), l ? f(t) : s;
                if (m) return c = setTimeout(b, o), f(u)
            }
            return void 0 === c && (c = setTimeout(b, o)), s
        }
        return o = O(o) || 0, x(e) && (l = !!e.leading, r = (m = "maxWait" in e) ? h(O(e.maxWait) || 0, o) : r, t = "trailing" in e ? !!e.trailing : t), g.cancel = function() {
    ...
    function O(e) {
        ...
        if ("symbol" == typeof(t = e) || t && "object" == typeof t && l.call(t) == i) return n;
        var t;
        if ("string" != typeof(e = x(e) ? x(o = "function" == typeof e.valueOf ? e.valueOf() : e) ? o + "" : o : e)) return 0 === e ? e : +e;
        e = e.replace(a, "");
        var o = s.test(e);
    ...
    function q(e) {
        ...
        var t;
        if ("string" != typeof(e = A(e) ? A(o = "function" == typeof e.valueOf ? e.valueOf() : e) ? o + "" : o : e)) return 0 === e ? e : +e;
        e = e.replace(f, "");
        var o = b.test(e);
    ...
    function L(n, o, e) {
        ...
        return o = q(o) || 0, A(e) && (l = !!e.leading, r = (m = "maxWait" in e) ? z(q(e.maxWait) || 0, o) : r, t = "trailing" in e ? !!e.trailing : t), g.cancel = function() {
            void 0 !== c && clearTimeout(c), i = u = a = c = void(d = 0)
        }, g.flush = function() {
    ...
    var D = function() {
        ...
        H = function(e, t) {
            var o = window.document,
                n = new(S())(M);
            T = t, n.observe(o.documentElement, {
                childList: !0,
                subtree: !0,
                removedNodes: !0
            })
    ...
    function K(e, t) {
        var o = void 0;
        return Z.ie11() ? (o = document.createEvent("CustomEvent")).initCustomEvent(e, !0, !0, {
            detail: t
        }) : o = new CustomEvent(e, {
            detail: t
    ...
    function G(e) {
        return e.forEach(function(e, t) {
            var o, n, i, a, r, s;
            o = e, n = window.pageYOffset, a = o.options, r = o.position, s = o.node, o.data, e = function() {
                var t, e;
                o.animated && (t = s, (e = a.animatedClassNames) && e.forEach(function(e) {
                    return t.classList.remove(e)
                }), K("aos:out", s), o.options.id && K("aos:in:" + o.options.id, s), o.animated = !1)
            }, a.mirror && n >= r.out && !a.once ? e() : n >= r.in ? o.animated || (i = s, (r = a.animatedClassNames) && r.forEach(function(e) {
                return i.classList.add(e)
            }), K("aos:in", s), o.options.id && K("aos:in:" + o.options.id, s), o.animated = !0) : o.animated && !a.once && e()
        })
    }
    ...
    function V() {
        var e, r;
        (te = 0 < arguments.length && void 0 !== arguments[0] && arguments[0] ? !0 : te) && (r = oe, (e = ee).forEach(function(e, t) {
            var o = Q(e.node, "mirror", r.mirror),
                n = Q(e.node, "once", r.once),
                i = Q(e.node, "id"),
                a = r.useClassNames && e.node.getAttribute("data-aos"),
                a = [r.animatedClassName].concat(a ? a.split(" ") : []).filter(function(e) {
                    return "string" == typeof e
                });
            r.initClassName && e.node.classList.add(r.initClassName), e.position = { in: function(e, t, o) {
                    var n = window.innerHeight,
                        ...
                        o = a || o,
                        r = e;
                    i && document.querySelectorAll(i) && (r = document.querySelectorAll(i)[0]);
                    var s = J(r).top - n;
                    switch (o) {
                        case "top-bottom":
                            break;
                ...
                out: o && function(e, t) {
                    ...
                    var o = Q(e, "anchor"),
                        t = Q(e, "offset", t),
                        e = e;
                    return o && document.querySelectorAll(o) && (e = document.querySelectorAll(o)[0]), J(e).top + e.offsetHeight - t
                }(e.node, r.offset)
            }, e.options = {
                once: n,
                mirror: o,
        ...
        }), G(ee = e), window.addEventListener("scroll", function(e, t, o) {
            var n = !0,
                i = !0;
            if ("function" != typeof e) throw new TypeError(y);
            return x(o) && (n = "leading" in o ? !!o.leading : n, i = "trailing" in o ? !!o.trailing : i), m(e, t, {
                leading: n,
                maxWait: t,
                trailing: i
            })
